...
void loop() 
{
  ...
  Serial.print(MCP.mV_MCP3304(0));
  Serial.println("mV");
  
  Serial.print("Channel 1: ");
  Serial.print(MCP.mV_MCP3304(1));
  Serial.println("mV");
  
  Serial.print("Channel 2: ");
  Serial.print(MCP.mV_MCP3304(2));
  Serial.println("mV");
  
  Serial.print("Channel 3: ");
  Serial.print(MCP.mV_MCP3304(3));
  Serial.println("mV");
  
  Serial.print("Channel 4: ");
  Serial.print(MCP.mV_MCP3304(4));
  Serial.println("mV");
  
  Serial.print("Channel 5: ");
  Serial.print(MCP.mV_MCP3304(5));
  Serial.println("mV");
  
  Serial.print("Channel 6: ");
  Serial.print(MCP.mV_MCP3304(6));
  Serial.println("mV");
  
  Serial.print("Channel 7: ");
  Serial.print(MCP.mV_MCP3304(7));
  Serial.println("mV");
